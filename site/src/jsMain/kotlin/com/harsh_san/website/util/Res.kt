package com.harsh_san.website.util
...
object Res {
    ...
    object Image {
        const val PROFILE_PHOTO = "harsh.jpg"
    }

    object Strings {
        const val NAME = "Harsh Wavikar"
        const val PROFESSION = "Full Stack Android Developer"
        const val ABOUT_ME =
            "HI, I am Harsh Wavikar, and Android developer based in Navi Mumbai. Please feel free to check out my work on Github."
        const val BUTTON_TEXT = "Get in touch"
        const val ROBOTO_CONDENSED = "RobotoCondensedBold"
        const val ROBOTO_REGULAR = "RobotoRegular"
M        const val MY_EMAIL = "mailto:harshwavikar123@gmail.com"
